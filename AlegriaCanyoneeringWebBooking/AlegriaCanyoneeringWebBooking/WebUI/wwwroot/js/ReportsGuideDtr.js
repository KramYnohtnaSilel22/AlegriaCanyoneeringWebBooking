$(document).ready(function () {
    ...
    $("#btnDownloadExcel").on("click", async function () {
        ...
        ws.mergeCells("A5:E5"); setCell("A5", "Tour Guide Daily Time Record", true, 13);
        ws.mergeCells("A6:E6"); setCell("A6", `${dateFromText} - ${dateToText}`, true, 10);
        ws.getRow(7).height = 5;

        // ---- Table header row 8 ----
        const headers = ["Seq.", "Guide Name", "RFID", "No. of Trips", "Total Guests"];
        ...
        ws.getCell(`A${noteIdx}`).value = "System Generated Report - Tour Guide DTR Summary";
